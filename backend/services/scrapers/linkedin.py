...
async def scrape_linkedin(job_title: str, industry: str, location: str, radius: int) -> List[JobItem]:
    ...
    urls = discover_job_urls("linkedin.com/jobs/view", job_title, location, max_results=8)
    ...
    try:
        ...
        url = f"https://www.linkedin.com/jobs/search?keywords={query}&location={loc_query}&distance={dist}&f_TPR=r7776000"
